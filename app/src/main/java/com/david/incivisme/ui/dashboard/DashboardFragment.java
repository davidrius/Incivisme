package com.david.incivisme.ui.dashboard;
...
import com.david.incivisme.databinding.FragmentDashboardBinding;
import com.david.incivisme.databinding.FragmentIncidenciasBinding;
import com.david.incivisme.databinding.FragmentNotificationsBinding;
import com.david.incivisme.Incidencia;
import com.david.incivisme.SharedViewModel;
...
public class DashboardFragment extends Fragment {
    ...
    class IncidenciaAdapter extends FirebaseRecyclerAdapter<Incidencia, IncidenciaAdapter.IncidenciaViewholder> {
        ...
        public IncidenciaViewholder onCreateViewHolder(
            ...
            return new IncidenciaViewholder(FragmentIncidenciasBinding.inflate(
                    LayoutInflater.from(parent.getContext()),
                    parent, false));
        }

        class IncidenciaViewholder extends RecyclerView.ViewHolder {
            FragmentIncidenciasBinding binding;

            public IncidenciaViewholder(FragmentIncidenciasBinding binding) {
